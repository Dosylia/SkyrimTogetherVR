...
before_build(function (target)
    ...
    -- BuildInfo.h is still included by the sources; it only carries fallbacks now, the real values are the defines.
    local buildInfoPath = "build/BuildInfo.h"
    local buildInfo = [[
#pragma once
// Generated by xmake (root xmake.lua). BUILD_BRANCH and BUILD_COMMIT come from compile defines; these are fallbacks.
#ifndef BUILD_BRANCH
