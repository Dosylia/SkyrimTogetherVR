...
BGSSaveFormBuffer::BGSSaveFormBuffer()
{
    ...
    POINTER_SKYRIMSE(CtorT, ctor, 36035, 36035);
...
BGSLoadFormBuffer::BGSLoadFormBuffer(const uint32_t aChangeFlags)
{
    ...
    POINTER_SKYRIMSE(CtorT, ctor, 35993, 35993);
...
static TiltedPhoques::Initializer s_saveLoadHooks(
    []()
    {
        POINTER_SKYRIMSE(TBGSLoadFormBuffer_ReadFormId, s_readFormId, 36000, 36000);
        POINTER_SKYRIMSE(TBGSSaveFormBuffer_WriteFormId, s_writeFormId, 36048, 36048);
        POINTER_SKYRIMSE(TBGSSaveFormBuffer_WriteId, s_writeId, 36047, 36047);
