...
void* EquipManager::EquipSpell(Actor* apActor, TESForm* apSpell, uint32_t aSlotId)
{
    ...
    POINTER_SKYRIMSE(TEquipSpellInternal, s_equipFunc, 38896, 38896);
...
void* EquipManager::UnEquipSpell(Actor* apActor, TESForm* apSpell, uint32_t aSlotId)
{
    ...
    POINTER_SKYRIMSE(TUnEquipSpellInternal, s_unequipFunc, 38903, 38903);
...
void* EquipManager::UnEquipShout(Actor* apActor, TESForm* apShout)
{
    ...
    POINTER_SKYRIMSE(TUnEquipShoutInternal, s_unequipFunc, 38903, 38903);
...
void EquipManager::UnequipAll(Actor* apActor)
{
    ...
    POINTER_SKYRIMSE(TUnEquipAll, s_unequipAll, 38899, 38899);
...
static TiltedPhoques::Initializer s_equipmentHooks(
    []()
    {
        POINTER_SKYRIMSE(TEquip, s_equipFunc, 38929, 38929);
        POINTER_SKYRIMSE(TUnEquip, s_unequipFunc, 38934, 38934);
        POINTER_SKYRIMSE(TEquipSpell, s_equipSpellFunc, 38928, 38928);
        POINTER_SKYRIMSE(TUnEquipSpell, s_unequipSpellFunc, 38933, 38933);
        POINTER_SKYRIMSE(TEquipShout, s_equipShoutFunc, 38930, 38930);
        POINTER_SKYRIMSE(TUnEquipShout, s_unequipShoutFunc, 38935, 38935);
