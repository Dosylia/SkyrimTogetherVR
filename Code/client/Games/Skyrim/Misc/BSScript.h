...
struct BSScript
{
    ...
    struct Stack
    {
        uint32_t GetPageForFrame(StackFrame* apFrame)
        {
            ...
            POINTER_SKYRIMSE(TGetPageForFrame, getPageForFrame, 104483, 104483);
    ...
    struct NativeFunction : NativeFunctionBase
    {
        virtual ~NativeFunction()
        {
            ...
            POINTER_SKYRIMSE(TNativeFunctionDtor, dtor, 104655, 104655);
        ...
        NativeFunction(const char* apFunctionName, const char* apClassName, bool aIsStatic, uint32_t aParameterCount)
        {
            ...
            POINTER_SKYRIMSE(TNativeFunctionCtor, ctor, 104653, 104653);
