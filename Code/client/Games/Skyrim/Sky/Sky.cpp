...
Sky* Sky::Get() noexcept
{
    ...
    POINTER_SKYRIMSE(SkyGet, skyGet, 13878, 13789);
...
void Sky::ResetWeather() noexcept
{
    ...
    POINTER_SKYRIMSE(TResetWeather, resetWeather, 26242, 25695);
...
static TiltedPhoques::Initializer s_skyHooks(
    []()
    {
        POINTER_SKYRIMSE(TSetWeather, setWeather, 26241, 25694);
        POINTER_SKYRIMSE(TForceWeather, forceWeather, 26243, 25696);
