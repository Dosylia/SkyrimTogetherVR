...
void hkbBehaviorGraph::ReSendEvent(hkEventContext& aContext, hkEventType& aType)
{
    ...
    POINTER_SKYRIMSE(THandleEvents, HandleEvents, 58377, 58377);
...
void hkbBehaviorGraph::ReHandleEvent(hkEventContext& aContext, hkEventType& aType)
{
    ...
    for (auto i = 0; i < counter; ++i)
    {
        ...
        if (!pSomeData->byte84)
        {
            ...
            if (pGraph->symbolIdMap && eventType >= 0)
            {
                ...
                POINTER_SKYRIMSE(Tsub_1409CA9D0, sub_1409CA9D0, 57185, 57185);
            ...
            if (eventType != -1)
            {
                ...
                if (pSomeData->byte85 == 0)
                {
                    ...
                    POINTER_SKYRIMSE(Tsub_140A13150, sub_140A13150, 59310, 59310);
    ...
    if (!(aContext.byte30 & 1))
    {
        ...
        POINTER_SKYRIMSE(Tsub_1409F3EF0, sub_1409F3EF0, 58378, 58378);
    ...
    if (byte12E || g_forceAnimation)
    {
        ...
        POINTER_SKYRIMSE(Tsub_140A4DFA0, sub_140A4DFA0, 60079, 60079);
...
bool BShkbAnimationGraph::ReSendEvent(BSFixedString* apEventName)
{
    if (behaviorGraph && behaviorGraph->byte12C)
    {
        if (hkxDB->ptr160)
        {
            ...
            POINTER_SKYRIMSE(Thash_stub, hash_stub, 68221, 68221);
    ...
    POINTER_SKYRIMSE(TBSSendEvent, InternalSendEvent, 63591, 63591);
...
uint32_t BSAnimationGraphManager::ReSendEvent(BSFixedString* apEventName)
{
    ...
    POINTER_SKYRIMSE(Tsub_140AE2DB0, sub_140AE2DB0, 63372, 63372);
...
bool IAnimationGraphManagerHolder::ReSendAnimationEvent(BSFixedString* apAnimEvent)
{
    ...
    POINTER_SKYRIMSE(TBSSendEvent, BSSendEvent, 63362, 63362);
...
uint8_t Class142F3A1E8::SendGraphAction(TESActionData* apAction)
{
    ...
    POINTER_SKYRIMSE(TGetSomeIdleProperty, GetSomeIdleProperty, 24568, 24568);
...
bool ActorMediator::RePerformAction(TESActionData* apAction) noexcept
{
    ...
    POINTER_SKYRIMSE(TAnimationStep, PerformIdleAction, 38952, 38952);
...
bool ActorMediator::RePerformIdleAction(TESActionData* apData) noexcept
{
    ...
    POINTER_SKYRIMSE(void*, qword_142F271C8, 403568, 403568);
...
bool TESActionData::ComputeResult()
{
    ...
    POINTER_SKYRIMSE(Tsub_1401A1D50, sub_1401A1D50, 15006, 15006);
